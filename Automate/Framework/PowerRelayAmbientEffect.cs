...
/// 3 tiles up from the bottom of its drawn sprite. Mirrors
...
/// objects. Just the main glint — this deliberately skips vanilla's own
...
/// the Relay's sprite entirely (confirmed by testing) since a smaller Y sorts earlier/further
...
internal class PowerRelayAmbientEffect
{
    ...
    *********/
    ...
    /// <summary>How many tiles up from the bottom of the Relay's drawn sprite the effect is centered.</summary>
    ...
    *********/
    ...
    public void Tick()
    {
        ...
        // location.temporarySprites' own per-frame cleanup effectively stalls then (confirmed by testing,
        // matching vanilla's own ore-panning sparkles doing the same thing) — without this
